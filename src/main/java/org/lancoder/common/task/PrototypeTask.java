...
public class PrototypeTask implements Serializable {
	...
	public PrototypeTask(int taskId, int stepCount, long encodingStartTime, long encodingEndTime, long unitCount,
			Unit unit) {
		this.taskId = taskId;
